...
personM1 = Person("CHARCA MOROCCO HERNAN WILSON",71624415)
personM2 = Person("JUAREZ CHAVEZ BILLY STEVE",73451618)
...
personW2 = Person("PEREZ VIZCARRA ALDO ALEXIS",72205691)
personX1 = Person("AQUISE ESCOBEDO SILVIA MELENIA",29583636)
personY1 = Person("YANCAPALLO VILCA ENRIQUE JAVIER",42904635)
personY2 = Person("HUACCA AROHUILLCA ELIZABETH ZAYDA",43053791)
personY3 = Person("MAMANI VILCA FRANCISCO MIGUEL",43002066)
personZ1 = Person("MEDINA CARPIO OSCAR CHRISTIAN",42172094)
personAA1 = Person("ESTREMADOYRO CUMPA ALBA GUADALUPE",45632840)
...
personAF2 = Person("PEÑALOZA CABANA ESTEFHANY",48568249)
personAF3 = Person("LAYME PONCE ISABEL MARIA",48055715)
personAF4 = Person("QUECCAÑO QUISPE AYDE ROXANA",71217127)
...
personAO1 = Person("ALARCON CHIPANA RICHARD MIGUEL",43613645)
personAO2 = Person("MONTESINOS AGUILAR DE ALARCON CLAUDIA HASSEL",74039250)
...
team1 = Team("academia pre  universitaria  virtual ALTO NIVEL",[personA1,personA2,personA3])
...
team16 = Team("Grupo Geagreen",[personO1,personO4,personO2,personO3])
...
team20 = Team("VIVE TU CARRERA AHORA",[personS1])
